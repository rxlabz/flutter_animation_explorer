...
class SyntaxHighlighterStyle {
  ...
  static SyntaxHighlighterStyle panacheThemeStyle() {
    return SyntaxHighlighterStyle(
        baseStyle: const TextStyle(color: Color(0xFFbbcccf)),
        numberStyle: const TextStyle(color: Color(0xFF90DBD4)),
        commentStyle: const TextStyle(color: Color(0xFF9E9E9E)),
        keywordStyle: const TextStyle(color: Color(0xFFF06292)),
        stringStyle: const TextStyle(color: Color(0xFFD4E157)),
        punctuationStyle: const TextStyle(color: Color(0xFFFDD835)),
        classStyle: const TextStyle(color: Color(0xFFFDD835)),
